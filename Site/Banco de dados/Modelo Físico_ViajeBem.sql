...
/* Inserção de Dados */
# Clientes
insert into viajebem.clientes (nome, email, senha) values 
...
# Destinos
insert into viajebem.destinos (destino, preco, transporte, promocao_id) values 
...
# Promoções
insert into viajebem.promocoes (desconto, validade_promocao, pacote) values 
...
# Compras
insert into viajebem.compra (data_hora_viagem, forma_pagamento, cliente_id, destino_id) values
...
# Clientes
update viajebem.clientes set nome = 'Bruna da Silva', email = 'brunasilva@hotmail.com', senha = '2508' where (id_cliente = '6');
update viajebem.clientes set nome = 'Silvana Santos', email = 'silvanasantos@hotmail.com', senha = '6743' where (id_cliente = '7');
update viajebem.clientes set nome = 'Miria Alves', email = 'miriaalves@gmaill.com', senha = '1534' where (id_cliente = '8');

# Destinos
update viajebem.destinos set destino = 'São Paulo', preco = '950.00' where (id_destino = '1');
update viajebem.destinos set destino = 'Fortaleza', preco = '690.00' where (id_destino = '14');

# Compra
update viajebem.compra set data_hora_viagem = '2023-12-25 10:30:00', forma_pagamento = 'Credito', cliente_id = '10', destino_id = '27' where (id_compra = '6');
update viajebem.compra set data_hora_viagem = '2023-10-15 11:00:00', forma_pagamento = 'Debito', cliente_id = '6', destino_id = '23' where (id_compra = '7');

# Promoções
update viajebem.promocoes set desconto = '0.20', validade_promocao = '2023-09-20 17:00:00', pacote = 'Internacional' where (id_promocao = '2');
update viajebem.promocoes set desconto = '0.25', validade_promocao = '2023-05-21 09:40:00', pacote = 'Nacional' where (id_promocao = '7');
